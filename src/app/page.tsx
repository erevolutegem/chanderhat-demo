...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-primary-dark relative">
      <div className="fixed top-0 left-0 z-[9999] bg-accent-yellow text-primary-dark text-xs font-black px-4 py-1 shadow-2xl tracking-tighter">DIAGNOSTIC_v6.0.0</div>
      <Navbar />
      <main>
        <HeroCarousel />
